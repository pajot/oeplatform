...
from modelview.model_legacy import *
...
class Scenario(models.Model):
    ...
    target_driven = CharField(
        max_length=200, blank=True
    )

    measure_driven = CharField(
        max_length=200, blank=True
    )
    ...
    scenario_years = models.CharField(max_length=200, blank=True)
    typical_year = models.CharField(verbose_name="Weather year, typical year, typical periods", max_length=200, blank=True)

    ## Spatial

    territory = models.CharField(max_length=200, blank=True)
    international_transport = models.CharField(verbose_name="International transport", max_length=200, blank=True)
    area_outside = models.CharField(verbose_name="Area outside of territory modelled", max_length=200, blank=True)
    upstream = models.CharField(
        verbose_name="Upstream chains outside the territory included?", max_length=200, blank=True)

    # Resolution

    ## Resolution of the analysis space

    temporal_resolution = models.CharField(max_length=200, blank=True)
    spatial_resolution = models.CharField(max_length=200, blank=True)

    ## Modelled energy sectors

    modeled_energy_sectors_electricity = models.CharField(max_length=200, blank=True)
    modeled_energy_sectors_heat = models.CharField(max_length=200, blank=True)
    modeled_energy_transport = models.CharField(max_length=200, blank=True)

    ## Modelled demand sectors

    sector_definition_based_on = models.CharField(max_length=200, blank=True)

    ## Modelled energy demand sectors

    energy_demand_sectors = models.CharField(max_length=200, blank=True)

    energy_demand_sectors_energy = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_industries = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_manufacturing = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_tertiary = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_private = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_transport = models.CharField(max_length=200, blank=True)
    energy_demand_sectors_other = models.CharField(max_length=200, blank=True)

    ## Modelled non-energy sectors

    sectors_agriculture = models.CharField(max_length=200, blank=True)
    sectors_lulucf = models.CharField(max_length=200, blank=True)
    sectors_waste = models.CharField(max_length=200, blank=True)
    sectors_other = models.CharField(max_length=200, blank=True)

    # Fuels

    fuels_fossil = models.CharField(max_length=200, blank=True)
    fuels_nuclear = models.CharField(max_length=200, blank=True)
    fuels_renewable = models.CharField(max_length=200, blank=True)
    fuels_secondary = models.CharField(max_length=200, blank=True)
    fuels_synthetic = models.CharField(max_length=200, blank=True)
    fuels_other = models.CharField(max_length=200, blank=True)

    # Modelling results

    ## Energy flows

    primary_energy = models.CharField(max_length=200, blank=True)
    final_energy = models.CharField(max_length=200, blank=True)
    other_energy = models.CharField(max_length=200, blank=True)

    ## Installed capacities

    energy_producers = models.CharField(max_length=200, blank=True)
    energy_transport = models.CharField(max_length=200, blank=True)
    energy_storages = models.CharField(max_length=200, blank=True)
    energy_consumers = models.CharField(max_length=200, blank=True)

    ## Protentials

    theoretical_potential = models.CharField(max_length=200, blank=True)
    technical_potential = models.CharField(max_length=200, blank=True)
    economic_potential = models.CharField(max_length=200, blank=True)
    developable_potential = models.CharField(max_length=200, blank=True)

    ## Environmental effects

    ef_Greenhouse_gas_emissions = models.CharField(max_length=200, blank=True)
    ef_carbon_dioxide  = models.CharField(max_length=200, blank=True)
    ef_methane = models.CharField(max_length=200, blank=True)
    ef_nitrous_oxide = models.CharField(max_length=200, blank=True)
    ef_hydrofluorocarbons = models.CharField(max_length=200, blank=True)
    ef_perfluorocarbons = models.CharField(max_length=200, blank=True)
    ef_sulphur_hexafluoride = models.CharField(max_length=200, blank=True)
    ef_nitrogen_fluoride = models.CharField(max_length=200, blank=True)

    ef_carbon_monoxide = models.CharField(max_length=200, blank=True)
    ef_nitrogen_oxide = models.CharField(max_length=200, blank=True)
    ef_nmvoc = models.CharField(max_length=200, blank=True)
    ef_sulfur_dioxide = models.CharField(max_length=200, blank=True)
    ef_ammonia  = models.CharField(max_length=200, blank=True)
    ef_pm = models.CharField(max_length=200, blank=True)

    # Exogeneous data

    exogeneous_population = models.CharField(max_length=200, blank=True)
    exogeneous_working_population = models.CharField(max_length=200, blank=True)

    exogeneous_gdp = models.CharField(max_length=200, blank=True)
    exogeneous_gva = models.CharField(max_length=200, blank=True)
    exogeneous_economic_other = models.CharField(max_length=200, blank=True)

    exogeneous_prices_energy_coal = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_petroleum = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_natural_gas = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_other_primary = models.CharField(max_length=200, blank=True)

    exogeneous_prices_energy_electricity = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_heat = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_liquid_fuels = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_synthetic_fuels = models.CharField(max_length=200, blank=True)
    exogeneous_prices_energy_other_secondary = models.CharField(max_length=200, blank=True)

    exogeneous_ets = models.CharField(max_length=200, blank=True)
    exogeneous_carbon_prices_other = models.CharField(max_length=200, blank=True)

    exogeneous_investment_cost_producers = models.CharField(max_length=200, blank=True)
    exogeneous_investment_cost_transport = models.CharField(max_length=200, blank=True)
    exogeneous_investment_cost_storage = models.CharField(max_length=200, blank=True)
    exogeneous_investment_cost_other = models.CharField(max_length=200, blank=True)


    # Endogene data

    endogene_population = models.CharField(max_length=200, blank=True)
    endogene_working_population = models.CharField(max_length=200, blank=True)

    endogene_gdp = models.CharField(max_length=200, blank=True)
    endogene_gva = models.CharField(max_length=200, blank=True)
    endogene_economic_other = models.CharField(max_length=200, blank=True)

    endogene_prices_energy_coal = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_petroleum = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_natural_gas = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_other_primary = models.CharField(max_length=200, blank=True)

    endogene_prices_energy_electricity = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_heat = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_liquid_fuels = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_synthetic_fuels = models.CharField(max_length=200, blank=True)
    endogene_prices_energy_other_secondary = models.CharField(max_length=200, blank=True)

    endogene_ets = models.CharField(max_length=200, blank=True)
    endogene_carbon_prices_other = models.CharField(max_length=200, blank=True)

    endogene_investment_cost_producers = models.CharField(max_length=200, blank=True)
    endogene_investment_cost_transport = models.CharField(max_length=200, blank=True)
    endogene_investment_cost_storage = models.CharField(max_length=200, blank=True)
    endogene_investment_cost_other = models.CharField(max_length=200, blank=True)
...
class Study(models.Model):
    ...
    aim = TextField(
        verbose_name="General Focus",
        help_text="What is the purpose (hypothesis) and research question of the study?",
        max_length=1000,
        blank=True,
    )

    authors = ArrayField(models.CharField(max_length=100), default=list, blank=True, null=True)
    ...
    funding_source = CharField(max_length=100, blank=True)
    funding_contact = CharField(max_length=100, help_text="Who is responsible for the funding sources?", blank=True)

    report = ForeignKey(Publication, on_delete=models.CASCADE, null=True, blank=True)

    oep_data = models.ManyToManyField(Table, blank=True)
    non_oep_data = ArrayField(models.CharField(max_length=200), default=list, blank=True)

    citation_reference = ArrayField(
        CharField(max_length=1000), verbose_name="Citation reference", null=True, blank=True
    )
    citation_doi = ArrayField(
        CharField(max_length=1000), verbose_name="Citation doi", null=True, blank=True
    )